    ...
    try:
        async with database.session() as session, session.begin():
            model = await RegisteredModelRepository.create(
                ...
                default_gpu_count=payload.default_gpu_count,
                runtime_defaults=payload.runtime_defaults.model_dump(mode="json"),
...
def _model_response(model: RegisteredModel) -> RegisteredModelResponse:
    return RegisteredModelResponse(
        ...
        default_gpu_count=model.default_gpu_count,
        runtime_defaults=model.runtime_defaults,
